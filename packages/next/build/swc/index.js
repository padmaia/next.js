...
async function transform(src, options) {
  ...
  if (
    options === null || options === void 0
      ? void 0
      : (ref = options.jsc) === null || ref === void 0
      ? void 0
      : ref.parser
  ) {
    var _syntax
    options.jsc.parser.syntax =
      (_syntax = options.jsc.parser.syntax) !== null && _syntax !== void 0
        ? _syntax
        : 'ecmascript'
  }
    ...
    const m =
      typeof src === 'string'
        ? await this.parse(
            ...
            options === null || options === void 0
              ? void 0
              : (ref1 = options.jsc) === null || ref1 === void 0
              ? void 0
              : ref1.parser
          )
        : src
...
function transformSync(src, options) {
  ...
  if (
    options === null || options === void 0
      ? void 0
      : (ref2 = options.jsc) === null || ref2 === void 0
      ? void 0
      : ref2.parser
  ) {
    var _syntax
    ...
    const m =
      typeof src === 'string'
        ? this.parseSync(
            ...
            options === null || options === void 0
              ? void 0
              : (ref3 = options.jsc) === null || ref3 === void 0
              ? void 0
              : ref3.parser
          )
        : src
