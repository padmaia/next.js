...
async function exportApp(dir, options, configuration) {
  ...
  return nextExportSpan.traceAsyncFn(async () => {
    ...
    const nextConfig =
      ...
      (await nextExportSpan
        ...
        .traceAsyncFn(() =>
          (0, _config).default(_constants1.PHASE_EXPORT, dir)
        ))
    ...
    if (telemetry) {
      telemetry.record(
        (0, _events).eventCliSession(_constants1.PHASE_EXPORT, distDir, {
          webpackVersion: null,
          cliCommand: 'export',
          isSrcDir: null,
    ...
    const pagesManifest =
      ...
      require((0, _path).join(
        distDir,
        isLikeServerless
          ? _constants1.SERVERLESS_DIRECTORY
          : _constants1.SERVER_DIRECTORY,
        _constants1.PAGES_MANIFEST
      ))
    ...
    for (const page of pages) {
      ...
      if (
        prerenderManifest === null || prerenderManifest === void 0
          ? void 0
    ...
    ;(0, _fs).writeFileSync(
      (0, _path).join(distDir, _constants1.EXPORT_DETAIL),
      JSON.stringify({
        version: 1,
        outDirectory: outDir,
        success: false,
    ...
    if (
      !options.buildExport &&
      (0, _fs).existsSync(
        (0, _path).join(distDir, _constants1.CLIENT_STATIC_FILES_PATH)
      )
    ) {
      if (!options.silent) {
        ...
        .traceAsyncFn(() =>
          (0, _recursiveCopy).recursiveCopy(
            ...
            (0, _path).join(
              outDir,
              '_next',
              _constants1.CLIENT_STATIC_FILES_PATH
            )
          )
        )
    }
    ...
    if (typeof nextConfig.exportPathMap !== 'function') {
      if (!options.silent) {
        Log.info(
          `No "exportPathMap" found in "${_constants1.CONFIG_FILE}". Generating map from "./pages"`
        )
      }
    ...
    if (!options.buildExport) {
      const { isNextImageImported } = await nextExportSpan
        ...
        .traceAsyncFn(() =>
          _fs.promises
            .readFile(
              (0, _path).join(distDir, _constants1.EXPORT_MARKER),
              'utf8'
            )
  ...
  Read more: https://nextjs.org/docs/messages/export-image-api`)
    ...
    const renderOpts = {
      ...
      canonicalBase:
        ((ref = nextConfig.amp) === null || ref === void 0
          ? void 0
          : ref.canonicalBase) || '',
      ampValidatorPath:
        ((ref1 = nextConfig.experimental.amp) === null || ref1 === void 0
          ? void 0
          : ref1.validator) || undefined,
      ampSkipValidation:
        ((ref2 = nextConfig.experimental.amp) === null || ref2 === void 0
          ? void 0
          : ref2.skipValidation) || false,
      ampOptimizerConfig:
        ((ref3 = nextConfig.experimental.amp) === null || ref3 === void 0
          ? void 0
          : ref3.optimizer) || undefined,
      locales: i18n === null || i18n === void 0 ? void 0 : i18n.locales,
      locale: i18n === null || i18n === void 0 ? void 0 : i18n.defaultLocale,
      defaultLocale:
        i18n === null || i18n === void 0 ? void 0 : i18n.defaultLocale,
    ...
    const timeout =
      (configuration === null || configuration === void 0
        ? void 0
        : configuration.experimental.staticPageGenerationTimeout) || 0
        ...
        return pageExportSpan.traceAsyncFn(async () => {
          ...
          for (const validation of result.ampValidations || []) {
            ...
            hadValidationError =
              hadValidationError ||
              (Array.isArray(
                ampValidationResult === null || ampValidationResult === void 0
                  ? void 0
